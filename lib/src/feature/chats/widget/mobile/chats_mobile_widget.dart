...
class ChatsMobileWidget extends StatefulWidget {
  const ChatsMobileWidget({super.key});

  @override
  State<ChatsMobileWidget> createState() => _ChatsMobileWidgetState();
}

class _ChatsMobileWidgetState extends State<ChatsMobileWidget> {
  ...
  Widget _buildBody(BuildContext context, ChatsState chatsState, List<Conversation> conversations) {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(chatsState.message, textAlign: TextAlign.center),
            ),
          ],
        ),
      );
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        return _MobileConversationTile(
          conversation: conv,
