...
final class BotSettingsController extends StateController<BotSettingsState>
  ...
  void load() => handle(
        () async {
          ...
          setState(BotSettingsState.idle(
            commands: commands,
  ...
  void saveCommands(List<BotCommand> commands) => handle(
        () async {
  ...
  void saveWelcomeMessage(String message) => handle(
        () async {
          setState(const BotSettingsState.saving());
  ...
  void saveAutoReply(String message) => handle(
        () async {
          setState(const BotSettingsState.saving());
  ...
  void saveDescription(String desc, String shortDesc) => handle(
        () async {
          setState(const BotSettingsState.saving());
