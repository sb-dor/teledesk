...
import 'package:teledesk/src/common/util/platform/keyboard_observer_vm.dart'
    // ignore: uri_does_not_exist
    if (dart.library.html) 'package:teledesk/src/common/util/platform/keyboard_observer_js.dart';
